...
import { Home, MessageSquare, BookOpen, User, Star, Mic, MicOff, Send, Lightbulb, History } from "lucide-react"
...
export function MainApp({ userProfile, updateProfile, onReset }: MainAppProps) {
  const [activeTab, setActiveTab] = useState<"home" | "chat" | "lessons" | "tips" | "profile" | "history">("home")
