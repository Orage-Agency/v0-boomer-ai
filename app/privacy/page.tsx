...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-start justify-center p-4 py-8">
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl p-6 md:p-10 relative">
        {/* Back Button */}
        <Link
          href="/"
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-center text-gray-500 mb-8">Effective Date: November 26, 2025</p>

          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Introduction</h2>
            <p className="text-gray-700 leading-relaxed">
              Welcome to Boomer AI ("we," "our," or "us"). We are committed to protecting your privacy and ensuring you
              have a positive experience on our website and in using our apps.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>
                <strong>User Content:</strong> We process the text and audio inputs you provide to generate AI responses
                and images.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              your account and all associated data at any time. To do so, please go to the Settings page in the app or
