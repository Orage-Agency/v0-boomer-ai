        ...
        {LESSONS.map((lesson, index) => {
          ...
          return (
            <Pressable
              ...
              accessibilityLabel={`Lesson ${index + 1}: ${lesson.title}${isDone ? ', completed' : ''}`}
            >
              <View style={[styles.icon, isDone ? styles.iconDone : styles.iconTodo]}>
                <Text style={styles.iconEmoji}>{isDone ? '✓' : '▶'}</Text>
              </View>
